...
Route::get('/article/{id}', [ArticleController::class, 'destroy'])->name('articles.destroy');
...
Route::get('/commentaire/{id}', [CommentaireController::class, 'destroy'])->name('commentaires.destroy');
